...
class Shape:
    ...
    def _location(self):
        ...
        tk coordinate system
        """
        # x1 = self.x + Paper.tk.paper_width//2
        x1 = self.cartesian_to_tk_x(self.x)
        # y1 = Paper.tk.paper_height//2 - self.y
        y1 = self.cartesian_to_tk_y(self.y)
        # x2 = self.x + Paper.tk.paper_width//2 + self.width
        x2 = self.cartesian_to_tk_x(self.x + self.width)
        # y2 = Paper.tk.paper_height//2 - self.y - self.height
        y2 = self.cartesian_to_tk_y(self.y + self.height)
        return [x1, y1, x2, y2]

    def cartesian_to_tk_x(self, x):
        """
        converse x in the Cartesian coordinate system to x in Tk
        """
        return x + Paper.tk.paper_width // 2

    def cartesian_to_tk_y(self, y):
        """
        converse y in the Cartesian coordinate system to y in Tk
        """
        return Paper.tk.paper_height // 2 - y
    ...
    def randomize(self, smallest=20, largest=200):
        ...
        self.x = random.randint(0, Paper.tk.paper_width // 2 - self.width // 2)
        self.y = random.randint(0, Paper.tk.paper_height // 2 - self.height // 2)
    ...
    def set_cx(self, x):
        """
        align the centre of the shape to x postion
        """
    ...
    def set_cy(self, y):
        """
        Sets the centre of the shape to y position
        """
...
class Rectangle(Shape):
    ...
    def draw(self):
        ...
        # Draw the rectangle
        Paper.tk.canvas.create_rectangle(x1, y2, x2, y1, fill=self.color)
...
class Oval(Shape):
    def draw(self):
        ...
        # Draw the oval
        Paper.tk.canvas.create_oval(x1, y2, x2, y1, fill=self.color)
...
class Triangle(Shape):
    ...
    def _location(self):
        ...
        return [
            self.cartesian_to_tk_x(self.x),
            self.cartesian_to_tk_y(self.y),
            self.cartesian_to_tk_x(self.x2),
            self.cartesian_to_tk_y(self.y2),
            self.cartesian_to_tk_x(self.x3),
            self.cartesian_to_tk_y(self.y3),
        ]
